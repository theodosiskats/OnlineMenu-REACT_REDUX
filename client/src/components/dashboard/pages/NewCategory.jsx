...
export default function NewCategory() {
  ...
  // SetSubCtgSelectionOptions(categories, subcategories)
  // function SetSubCtgSelectionOptions(categories, subcategories) {
  //   let SubCtgOptionsArray = []
  //   for(category of categories){
  //     for(subcategory of subcategories){
  //       SubCtgOptionsArray.category.name.push(subcategory.name)
  //     }
  //   }
  //   console.log('SubCtgOptionsArries', SubCtgOptionsArries)
  // }
